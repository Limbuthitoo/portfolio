      ...
      <div className="min-h-screen px-4 py-4 sm:py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="hidden sm:block text-center mb-8">
            ...
            <p className="text-[var(--fg-3)] text-sm">Stack blocks. Clear lines. Beat the high score.</p>
          </div>
          <UltraTetris />
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          >
            ...
            <p className="text-[var(--fg-3)] text-sm">
              Stack blocks, clear lines, and compete for the top 3 high scores.
            </p>
          </button>
          ...
          >
            ...
            <p className="text-[var(--fg-3)] text-sm">
              Battle a friend online — clear lines to send garbage blocks!
            </p>
          </button>
        </div>
      </div>
